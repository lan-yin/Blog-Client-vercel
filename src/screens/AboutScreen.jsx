      ...
      >
        <Table>
          <Tr>
            ...
            <Td>
              <p>
                大學就讀醫學檢驗暨生物技術學系，工作經歷6-7年，對生命抱有熱情和好奇心，因此在工作之餘也嘗試很多其他活動，偶然一次機會接觸到程式語言，打開我對電腦使用的認知，原以為程式語言深不可測，但經過在學習之後也能夠產出很多有趣的小專案。
              </p>
              <p>
                在學習程式語言的過程中，也是一個自我探索、翻轉大腦的過程，從原本醫護人員嚴謹的 SOP
                大腦（不能出錯），到在一個框架下，可以隨機應變（Debug）和創造，讓我覺得很有趣，加上 IT
                產業日新月異，需要不斷學習的特色，於是萌生轉職的想法。
              </p>
            </Td>
          </Tr>
          <Tr>
